...
function create() {
  ...
  reset = this.add.text(725, 16, 'Reset', {fontSize:'25px', fill: 'black' , border: '1px solid black'});
  ...
  score = 0;
  scoreText = this.add.text(16, 16, 'Score: ' + score, {fontSize:'25px', fill:'#000'});

  healthText = this.add.text(400, 16, "Health: " + player.health, {fontSize:'25px', fill:'#000'});
